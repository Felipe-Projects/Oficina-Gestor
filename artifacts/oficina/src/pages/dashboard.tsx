                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2 min-w-0">
                      <div className={cn(
                        ...
                        isUrgente ? "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400" :
                        isProximo ? "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400" :
                    ...
                    <span className={cn(
                      ...
                      isUrgente ? "bg-red-100 text-red-800 dark:bg-red-900/40 dark:text-red-400" :
                      isProximo ? "bg-amber-100 text-amber-900 dark:bg-amber-900/40 dark:text-amber-400" :
                  ...
                  <tr key={os.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={cn(
                        ...
                        os.status === 'orcamento' ? "bg-blue-100 text-blue-900 dark:bg-blue-900/30 dark:text-blue-400" :
                        os.status === 'em_andamento' ? "bg-amber-100 text-amber-900 dark:bg-amber-900/30 dark:text-amber-400" :
                        os.status === 'finalizado' ? "bg-emerald-100 text-emerald-900 dark:bg-emerald-900/30 dark:text-emerald-400" :
